...
export default function Login(props) {
    ...
    async function getIdentity() {
        ...
        try {
            const idUrl = loginType === 'client' ? 'http://' + window.location.hostname + '/current_user' : 'http://' + window.location.hostname + '/current_contractor';
    ...
    async function login() {
        ...
        const url = loginType === 'client' ? 'http://' + window.location.hostname + '/login-user' : 'http://' + window.location.hostname + '/login-contractor'; 
        try {
